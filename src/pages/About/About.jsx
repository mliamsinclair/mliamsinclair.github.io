    ...
    <div className="About" id={id}>
      ...
      <div className="about-section">
        ...
        <p>
          ...
          of creativity, logical thinking, and perpetual discovery fuels my
          passion and excitement for innovative software development. I greatly
          enjoy working in teams and am constantly seeking new opportunities to
          expand my knowledge and skillset. I am actively seeking an
